...
>
  <head>
    ...
    <meta name="description" content="Halaman form tambah jabatan." />
              ...
              <div class="row">
                <div class="col-12 mb-4">
                  <div class="card" style="background: linear-gradient(180deg, #f9f4ea 0%, #ddc6a7 100%); border-color: rgba(78, 59, 35, 0.18);">
                    <div class="card-body">
                      <h4 class="card-title mb-2" style="color: #4e3b23;">Tambah Jabatan</h4>
                      <p class="text-muted mb-4">Tambahkan jabatan baru untuk karyawan Anda.</p>
