            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-12 mb-4">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title mb-2">Edit Pengajuan Cuti</h4>
                      <p class="text-muted mb-4">Ubah informasi pengajuan cuti Anda.</p>
                      ...
                      <form action="{{ route('cuti.update', $cuti) }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                          <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_masuk') is-invalid @enderror"
                              ...
                              value="{{ old('tanggal_masuk', $cuti->tanggal_masuk) }}" required />
                            @error('tanggal_masuk')
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_keluar') is-invalid @enderror"
                              ...
                              value="{{ old('tanggal_keluar', $cuti->tanggal_keluar) }}" required />
                        ...
                        <div class="mb-4">
                          ...
                          <textarea class="form-control @error('alasan_cuti') is-invalid @enderror"
                            id="alasan_cuti" name="alasan_cuti" rows="4" required>{{ old('alasan_cuti', $cuti->alasan_cuti) }}</textarea>
                          @error('alasan_cuti')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
